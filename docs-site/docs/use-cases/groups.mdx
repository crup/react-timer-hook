...
For live demos, see [timer group](/recipes/advanced/timer-group), [group controls](/recipes/advanced/group-controls), [per-item polling](/recipes/advanced/per-item-polling), and [dynamic items](/recipes/advanced/dynamic-items).
