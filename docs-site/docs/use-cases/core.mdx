...
For live demos, see [wall clock](/recipes/basic/wall-clock), [stopwatch](/recipes/basic/stopwatch), [absolute countdown](/recipes/basic/absolute-countdown), and [OTP resend cooldown](/recipes/basic/otp-resend).
